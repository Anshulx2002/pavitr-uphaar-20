...
const IncenseAgarbatti = () => {
  const [currentPage, setCurrentPage] = useState(1);
  const itemsPerPage = 12;
  
  const allProducts = getProductsByCategory("incense");
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              ...
              <br />
              <span className="text-foreground">Agarbatti</span>
            </h1>
            
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Pure, hand-rolled incense sticks crafted with natural ingredients to create a divine atmosphere for your prayers and meditation.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="text-center py-20">
              <div className="max-w-md mx-auto">
                ...
                <p className="text-muted-foreground">
                  We couldn't find any incense products at the moment. Please check back later.
                </p>
              </div>
            </div>
          )}
...
export default IncenseAgarbatti;