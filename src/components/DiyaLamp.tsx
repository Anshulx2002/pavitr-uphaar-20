...
const DiyaLamp = () => {
  ...
  return (
    <div className={`absolute right-4 md:right-8 lg:right-12 top-1/2 transform -translate-y-1/2 transition-all duration-1000 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
      <div className="relative w-16 h-20 md:w-20 md:h-24 lg:w-24 lg:h-28">
        {/* Soft Golden Glow */}
        <div className="absolute inset-0 bg-gradient-radial from-[#DAA520]/30 via-[#F39C12]/20 to-transparent rounded-full scale-150 animate-pulse opacity-80"></div>
        <div className="absolute inset-0 bg-gradient-radial from-[#FFD700]/25 via-[#DAA520]/15 to-transparent rounded-full scale-125 opacity-70"></div>
        ...
        {/* Flame Light Effect */}
        <div className="absolute top-0 right-2 w-6 h-8 bg-gradient-radial from-[#FFA726]/40 via-[#FF8C42]/20 to-transparent rounded-full animate-pulse"></div>
      </div>
    </div>
  );
};
